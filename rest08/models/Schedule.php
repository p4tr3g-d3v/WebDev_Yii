...
class Schedule extends ActiveRecord
{
    public function loadAndSave($bodyParams){
        $schedule = ($this->isNewRecord) ? new Schedule() : Schedule::findOne($this->schedule_id);
    ...
    public function fields(){
        ...
        return array_merge($fields, [
            'schedule_id' => function () { return $this->schedule_id;},
            ...
            'user_id' => function () { return $this->lessonPlan->user_id;},
            'user_fio' => function () { return $this->lessonPlan->user->user->firstname;},
            'day_id' => function () { return $this->day_id;},
            'day_name' => function () { return $this->day->name;},
            'lesson_num_name' => function () { return $this->lessonNum->name;},
            'classroom_id' => function () { return $this->classroom_id;},
            'classroom_name' => function () { return $this->classroom->name;},
        ]);
    }
    /**
     * {@inheritdoc}
